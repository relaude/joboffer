...
namespace JO.BlazorDemoApp.Components.Pages.TALead.TabsDiscussion
{
    public partial class TabJOLetterDiscuss
    {
        ...
        private async Task AcceptAndComplete()
        {
            ...
            try
            {
                ...
                // Accepted & Completed, TA Lead, Tag Accepted & Completed
                await ApprovalService.JobOfferActionFlowStatus(jobOfferId, 9, 2, 6, userId, "Job Offer Completed.");
            ...
            Navigation.NavigateTo($"{JORoutes.TALead.JobOfferComplete}/{jobOfferId}");
        }
        ...
        private async Task Decline()
        {
            ...
            try
            {
                ...
                // Declined, TA Lead, Tag Decline
                await ApprovalService.JobOfferActionFlowStatus(jobOfferId, 12, 2, 9, userId, "Declined Job Offer");
        ...
        private async Task ForNegotiation()
        {
            ...
            // For Negotiation, TA Lead, Tag For Negotiation
            await ApprovalService.JobOfferActionFlowStatus(jobOfferId, 11, 2, 8, userId, $"Tag For Negotiation ({numProposal} Proposal/s)");
            ...
            Navigation.NavigateTo($"{JORoutes.TALead.ForNegotiation}/{jobOfferId}");
        }
    }
}
