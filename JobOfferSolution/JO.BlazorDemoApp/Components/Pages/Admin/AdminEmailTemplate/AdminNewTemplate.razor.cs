...
{
    public partial class AdminNewTemplate
    {
        [Inject] private IEmailTemplateService EmailTemplateService { get; set; } = default!;
        [Inject] private IEmailService EmailService { get; set; } = default!;
        [Inject] private ILogger<AdminNewTemplate> Logger { get; set; } = default!;
        ...
        private async Task SaveTemplateAsync()
        {
            ...
            try
            {
                ...
                Navigation.NavigateTo($"{JORoutes.Admin.EmailTemplate}/{templateId}");
            }
            finally
            {
