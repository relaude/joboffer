...
namespace JO.BlazorDemoApp.Components.Pages.President.Aproval
{
    public partial class JOForPresidentApprovalList
    {
        ...
        private static readonly int[] ForApprovalWorkFlowIds = [7];
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            joDboxCandidates = await JODetailsService.GetForApprovalReviewJODboxCandidates(userId, 7); //For President Approval
