...
namespace JO.BlazorDemoApp.Components.Pages.DHL1.Approval
{
    public partial class JOForDHL1ForApprovalList
    {
        [Inject] private IJODetailsService JODetailsService { get; set; } = default!;

        private const int ForApprovalWorkFlowId = 5;
        ...
        private int?[] approvedIDs = { 6, 7, 8, 9 };
