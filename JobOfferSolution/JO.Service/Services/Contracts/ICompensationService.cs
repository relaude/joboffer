...
namespace JO.Service.Services.Contracts
{
    public interface ICompensationService
    {
        ...
        Task<int> TALeadSubmitForApproval(JobOffers jobOffer, JOAnalysis joAnalysis, List<JOCompanyCompensation> joCompanyCompensation, List<JOCompanyCompensationItems> joCompanyCompensationItems, int selectedCmpnyCmpnstnId, int candidateId, int userId, string taPartnerRemarks);
